  ...
  return (
    <main className="featurePage">
      <header className="featureHeader">
        ...
        <span className="pill">GBK LEARN</span>
        <h1>Learning &amp; Education</h1>
        <p>Simple, practical education for blockchain, AI, GBK tools and founder participation.</p>
      </header>
      ...
      <div className="notice large">
        Education content is informational. Members should independently review transaction details,
        fees, eligibility and published program terms before participating.
      </div>
    </main>
  );
}
